  ...
  const handleCreateInscription = async () => {
    try {
      ...
      if (result.success) {
        ...
        // Reset form  CreateImageInscription 
        setTextData('');
        setImageFile(null);
        setImagePreview('');
    ...
    <div>
      ...
      <div className="p-4 bg-gray-700 rounded-lg border border-gray-600">
        <div className="space-y-4">
          ...
          {/* Show encryption options for all types except largeProfile, largeProfile2, and encryptedProperty   && inscriptionType !== 'encryptedProperty' */}
          ...
          <div className="space-y-4 mt-6">
            {inscriptionType === 'largeProfile' || inscriptionType === 'largeProfile2' || inscriptionType === 'encryptedProperty' ? (
              ...
              <>
                ...
                {/* Encrypted Data Display   View & Reconstruct  */}
                {encryptionLevel > 0 ? (
