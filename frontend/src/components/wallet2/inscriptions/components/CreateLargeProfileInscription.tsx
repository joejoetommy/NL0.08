...
// Reduced to 1MB for better compatibility
        ...
        <>
          <div className="p-3 bg-yellow-900 bg-opacity-30 rounded-lg border border-yellow-700">
            ...
            <p className="text-xs text-yellow-200 mt-1">
              Chunk size: {CHUNK_SIZE_MB}MB | Max chunks: 290 (~290MB total)
            </p>
          </div>
          ...
          <div className="p-3 bg-blue-900 bg-opacity-30 rounded-lg border border-blue-700">
            <h4 className="text-sm font-medium text-blue-300 mb-1">BCAT Protocol Specification:</h4>
            <ul className="text-xs text-gray-300 space-y-1">
              <li>• Namespace: {BCAT_NAMESPACE}</li>
              <li>• Part namespace: {BCAT_PART_NAMESPACE}</li>
              <li>• Requires 7+ arguments in main transaction</li>
              <li>• Supports files up to ~290MB with 100KB transaction limit</li>
              <li>• Each chunk stored as BCAT part transaction</li>
            </ul>
          </div>
