...
// Fix the fetchInscriptionContent function parameter type
const fetchInscriptionContent = async (selectedInscription: InscriptionData) => {
  setLoadingContent(true);
  setSelectedInscription(selectedInscription as any);
...
// Update the fetchInscriptions function to properly detect profile vs profile2
...
// Update your filter buttons JSX
...
// Update your inscriptions grid to use filtered inscriptions
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
  {getFilteredInscriptions().map((inscription) => (
    ...
    >
      {/* Rest of your inscription card JSX */}
    </div>
  ))}
</div>

// Update the modal content display to handle profile2 properly
{(selectedInscription.inscriptionType === 'profile' || 
  selectedInscription.inscriptionType === 'profile2') && inscriptionContent && (
  <div className="bg-gray-900 p-4 rounded mb-4">
    ...
    {inscriptionContent.p && (
      <p className="text-xs text-purple-400 mt-2">Type: {inscriptionContent.p}</p>
    )}
    {selectedInscription.inscriptionType === 'profile2' && inscriptionContent.background && (
      <div className="mt-4">
