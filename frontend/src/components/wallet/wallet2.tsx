// This is the messages working correctly selectedContactId 

import React, { useState, useEffect } from 'react';
// @ts-ignore
import { PrivateKey, PublicKey, Utils, SymmetricKey, Hash } from '@bsv/sdk';
import { examplePublicKeys, getRandomExamplePublicKey } from './data2';

type Network = 'mainnet' | 'testnet';
type ViewMode = 'wallet' | 'contacts' | 'messages';
...
// Remove contact
  ...
  const encryptMessage = () => {
    ...
    try {
      ...
      // Derive shared secret selectedContactId 
      const contactPubKey = PublicKey.fromString(contact.publicKeyHex);
