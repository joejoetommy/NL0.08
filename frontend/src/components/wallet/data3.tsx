...
export const cryptoChatData: TokenMail[] = [
  {
    ...
    text: "Hey, just sent you 0.5 BTC for the development work. Let me know when it arrives!",
    ...
    replies: [
      ...
      },
      {
        ...
        text: "Perfect! Looking forward to seeing the final product. Keep me posted on the progress.",
  ...
  },
  {
    ...
    text: "Can we schedule a meeting to discuss the smart contract audit? I have some concerns about the gas optimization.",
  ...
  },
  {
    ...
    text: "The NFT marketplace integration is ready for testing. You can access the staging environment with the credentials I sent earlier.",
  ...
  },
  {
    ...
    text: "Hey, I noticed some unusual activity on the testnet. Can you check if your nodes are syncing properly?",
    ...
    replies: [
      ...
      },
      {
        ...
        text: "Great! Everything looks normal now. BTW, did you see the new EIP proposal? Might affect our Layer 2 implementation.",
  ...
  },
  {
    ...
    text: "The DAO governance token distribution is complete. 10,000 tokens have been allocated to your address as discussed.",
...
export const additionalMessages: TokenMail[] = [
  {
    ...
    text: "Quick update: The mainnet deployment went smoothly. All systems are operational.",
  ...
  },
  {
    ...
    text: "Found a potential security vulnerability in the staking contract. We should discuss this ASAP.",
  ...
  },
  {
    ...
    text: "The audit report from CertiK just came in. Overall positive with minor suggestions. Forwarding now.",
  ...
  },
  {
    ...
    text: "The gas optimization worked perfectly! We're saving about 40% on each transaction now. Great job!",
  ...
  },
  {
    ...
    text: "Reminder: Investor call tomorrow at 2 PM EST. They want to see the DeFi integration demo.",
  ...
  },
  {
    ...
    text: "Have you seen the latest Ethereum upgrade proposal? Could impact our rollup strategy.",
  ...
  },
  {
    ...
    text: "UI/UX updates are live on staging. Added dark mode and improved wallet connection flow.",
  ...
  },
  {
    ...
    text: "Performance metrics are impressive: 0.3s average transaction time, 99.9% uptime last month.",
  ...
  },
  {
    ...
    text: "Cross-chain bridge testing complete. Successfully transferred assets between Ethereum and Polygon.",
  ...
  },
  {
    ...
    text: "Heads up: Network congestion expected during the NFT drop tomorrow. Might want to increase gas limits.",
  ...
  },
  {
    ...
    text: "Community feedback on the governance proposal is overwhelmingly positive. 87% approval rate so far.",
  ...
  },
  {
    ...
    text: "Treasury report: We have 2.5M in stablecoins and 150 ETH. Runway looks good for 18 months.",
