...
import { textPosts } from '@/components/data/(wall)/wallt4';  // currently set up to fetch test data from a local file, to be changed to API call the data
import {
  Dialog,
  DialogTrigger,
  DialogContent,
...
import TokenCount from '@/components/item/(wallt4items)/Tokencount';
  ...
  return (
    <div className="container mx-auto p-4">
      <div className="flex justify-between items-center mt-4">
        ...
        <div className="flex items-center space-x-2">
          <AddWallt4 onReviewAdded={onReviewAdded} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded ml-2" />
        </div>
        <div className="flex items-center space-x-2">
