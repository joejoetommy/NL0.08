  ...
  return (
    ...
    >
        ...
        return (
          <button
            ...
            className={classNames(
              'text-s relative flex items-center h-10 px-1 z-10 bg-transparent cursor-pointer select-none transition-colors justify-center hover:bg-white/10 duration-200 py-2',
              {
      ...
      {selectedRect && navRect && (
        <motion.div
          className={
            'absolute z-1 bottom-0 left-0.5 h-[5px] bg-sky-500 dark:bg-sky-500 rounded-full'
          }
          initial={false}
          animate={{
